...
require.scopes["filterNotifier"] = (function()
{
  ...
  var FilterNotifier = exports.FilterNotifier =
  {
    ...
    {
      for (var _loopIndex3 = 0; _loopIndex3 < listeners.length; ++_loopIndex3)
      {
        var listener = listeners[_loopIndex3];
...
require.scopes["matcher"] = (function()
{
  ...
  var RegExpFilter = _tempVar21.RegExpFilter;
  var WhitelistFilter = _tempVar21.WhitelistFilter;
...
require.scopes["filterListener"] = (function()
{
  ...
  var ActiveFilter = _tempVar22.ActiveFilter;
  var RegExpFilter = _tempVar22.RegExpFilter;
  var ElemHideBase = _tempVar22.ElemHideBase;
  var Prefs = require("prefs").Prefs;
  var batchMode = false;
  var isDirty = 0;
  ...
  function onGenericChange(action)
  {
    if (action == "load")
    {
      ...
      ElemHide.clear();
      for (var _loopIndex23 = 0; _loopIndex23 < FilterStorage.subscriptions.length; ++_loopIndex23)
      {
        var subscription = FilterStorage.subscriptions[_loopIndex23];
...
{
  var exports = {};
  var _tempVar24 = require("downloader");
  var Downloader = _tempVar24.Downloader;
  var Downloadable = _tempVar24.Downloadable;
  var MILLIS_IN_SECOND = _tempVar24.MILLIS_IN_SECOND;
  var MILLIS_IN_MINUTE = _tempVar24.MILLIS_IN_MINUTE;
  var MILLIS_IN_HOUR = _tempVar24.MILLIS_IN_HOUR;
  var MILLIS_IN_DAY = _tempVar24.MILLIS_IN_DAY;
  var _tempVar25 = require("filterClasses");
  var Filter = _tempVar25.Filter;
  var CommentFilter = _tempVar25.CommentFilter;
  var FilterStorage = require("filterStorage").FilterStorage;
  var FilterNotifier = require("filterNotifier").FilterNotifier;
  var Prefs = require("prefs").Prefs;
  var _tempVar26 = require("subscriptionClasses");
  var Subscription = _tempVar26.Subscription;
  var DownloadableSubscription = _tempVar26.DownloadableSubscription;
  var Utils = require("utils").Utils;
  ...
  var Synchronizer = exports.Synchronizer =
  {
    ...
    _onDownloadSuccess: function(downloadable, responseText, errorCallback, redirectCallback)
    {
      ...
      var _tempVar28 = downloader.processExpirationInterval(expirationInterval);
      var softExpiration = _tempVar28[0];
      var hardExpiration = _tempVar28[1];
...
require.scopes["notification"] = (function()
{
  var exports = {};
  var Prefs = require("prefs").Prefs;
  var _tempVar30 = require("downloader");
  var Downloader = _tempVar30.Downloader;
  var Downloadable = _tempVar30.Downloadable;
  var MILLIS_IN_MINUTE = _tempVar30.MILLIS_IN_MINUTE;
  var MILLIS_IN_HOUR = _tempVar30.MILLIS_IN_HOUR;
  var MILLIS_IN_DAY = _tempVar30.MILLIS_IN_DAY;
  var Utils = require("utils").Utils;
  ...
  var Notification = exports.Notification =
  {
    ...
    _onDownloadSuccess: function(downloadable, responseText, errorCallback, redirectCallback)
    {
      ...
      var _tempVar31 = downloader.processExpirationInterval(EXPIRATION_INTERVAL);
      Prefs.notificationdata.softExpiration = _tempVar31[0];
      Prefs.notificationdata.hardExpiration = _tempVar31[1];
      saveNotificationData();
    },
    _onDownloadError: function(downloadable, downloadURL, error, channelStatus, responseStatus, redirectCallback)
    {
    ...
    getNextToShow: function()
    {
      ...
      for (var _loopIndex33 = 0; _loopIndex33 < notifications.length; ++_loopIndex33)
      {
        var notification = notifications[_loopIndex33];
        ...
        {
          var match = false;
          for (var _loopIndex34 = 0; _loopIndex34 < notification.targets.length; ++_loopIndex34)
          {
            var target = notification.targets[_loopIndex34];
    ...
    getLocalizedTexts: function(notification, locale)
    {
      ...
      var localizedTexts = [];
      for (var _loopIndex35 = 0; _loopIndex35 < textKeys.length; ++_loopIndex35)
      {
        var key = textKeys[_loopIndex35];
